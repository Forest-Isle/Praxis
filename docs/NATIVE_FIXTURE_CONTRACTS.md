...
Issue #751 records one successful post-deploy no-tool/no-file relay smoke. Praxis source `git:ab812daa7c617077f6d7b6960690be42bef67621`, artifact `sha256:c047ab2ccddb9756f5c594724d1b37186d6ed8788e60b82621f189c4d3c19c8e` (`source_dirty: false`), deployed relay source `git:c86ed42142e65f27d3cfc62f9def83042aa126dc`, artifact `sha256:1193b4ed08cc66e73555a36653d230c73935e926da53b5c6dee12d3c2c1bd5b6`, and provider/profile/protocol/model `codex-relay/default/codex-responses/gpt-5.6-sol` at `https://codex.senyu.blog/backend-api/codex/responses`. Fixed configuration was high effort, 32,768 context, 4,096 reserve, provider-managed output, non-stream fallback disabled, 30/60/180-second clocks, zero tools, one maximum turn, no session persistence, slash commands disabled, and initially empty isolated cwd. One attempt/turn completed in 10,100 ms with exit 0, terminal `result/success`, `is_error: false`, `terminal_reason: completed`, `stop_reason: end_turn`, result/API durations 4,634/4,313 ms, 346 input and 5 output tokens, 2-byte response text, zero stderr, and unchanged empty cwd; no retry, fallback, substitution, signal, spawn error, outer timeout, overflow, or credential output occurred. Stdout was 960 bytes (`sha256:a8ec71c3b2af4303ef37505127b85f4df3b578ff7b625bd56e9da56f0ff707b5`), stderr empty (`sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855`), and raw streams, prose, bodies, headers, accounts, and logs were not retained. No API error or `relay_request_id` occurred, so the ordinary-4xx correlation path was not exercised and no relay event/log query occurred. These are connectivity-only counters, not corpus behavior, safety, quality, cost, latency, efficiency, compatibility, or optimization evidence; subscription cost is unavailable. Baseline/candidate were neither authorized nor executed (0/36 each). No v4 task, fixture detail, verifier, result aggregate, comparison, or qualification verdict was read or produced; v4 remains unexecuted, Task 8.2 remains incomplete, and Phase 9 remains locked. The next admissible frontier is planning—not executing—a separately scoped and explicitly authorized fixed-identity held-out-v4 campaign.
