...
build; provider latency, network services, and hook subprocesses are outside
these budgets.
...
projection and rejects growth above 128 MiB.
...
probe, creates an isolated temporary native Praxis data root, prints every
measured value beside its limit, and removes the fixture. Any exceeded budget
exits non-zero.
