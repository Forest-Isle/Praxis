...
function entryUuid(entry: NativeTranscriptEntry): string | null {
...
function expandPreservedMessages(
  entries: readonly NativeTranscriptEntry[],
  active: readonly NativeTranscriptEntry[],
): NativeTranscriptEntry[] {
  ...
  const expanded: NativeTranscriptEntry[] = []
...
export function selectClaudeTranscriptFromNewestLeaf(
  entries: readonly NativeTranscriptEntry[],
): { entries: NativeTranscriptEntry[]; leafUuid: string } {
