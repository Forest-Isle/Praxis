...
function isUserMessage(entry: ClaudeTranscriptEntry): boolean {
  if (
    entry.type !== 'user' ||
...
function snapshots(entries: readonly ClaudeTranscriptEntry[]) {
...
function trackedPaths(entries: readonly ClaudeTranscriptEntry[]): Set<string> {
...
export class ClaudeFileHistory {
  ...
  async prepareMutation(
    ...
    commit(messageId: string): ClaudeTranscriptEntry | null
